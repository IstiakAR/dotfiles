...
### Necessary packages
```bash
sudo pacman -S ark blueberry bluez btop cava cliphist copyq curl eza fastfetch feh firefox-developer-edition fzf gimp grim gtk3 gtk4 git gsimplecal gwenview i3 i3locks hyprlock hyprland hypridle kitty mpv neovim nm-connection-editor nwg-look picom polybar maim okular rofi stow swaybg swaync swww thunar tree unzip vivaldi vlc waybar wget xautolock yazi zsh zsh-autosuggestions zsh-syntax-highlighting
```
