...
### Necessary packages
```bash
sudo pacman -S ark blueberry bluez btop cava cliphist curl eza fastfetch feh firefox-developer-edition fzf gimp grim gtk3 gtk4 git gwenview i3 i3locks hyprlock hyprland hypridle kitty mpv neovim nm-connection-editor nwg-look picom polybar maim okular rofi stow swaybg swaync swww thunar tree tree-sitter-cli unzip vivaldi vlc waybar wget xautolock yazi zsh zsh-autosuggestions zsh-syntax-highlighting
```
